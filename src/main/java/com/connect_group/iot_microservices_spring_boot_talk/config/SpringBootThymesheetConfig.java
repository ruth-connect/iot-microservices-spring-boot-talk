package com.connect_group.iot_microservices_spring_boot_talk.config;
...
import com.connect_group.iot_microservices_spring_boot_talk.thymeleaf.IotMicroservicesSpringBootTalkDialect;
import com.connect_group.iot_microservices_spring_boot_talk.thymesheet.SpringBootThymesheetTemplateModeHandler;
...
public class SpringBootThymesheetConfig {
	...
	public SpringThymesheetTemplateEngine templateEngine() {
		...
		additionalDialects.add(new IotMicroservicesSpringBootTalkDialect());
